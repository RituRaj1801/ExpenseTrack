...
<head>
    ...
    <style>
        :root {
            ...
            --accent-green: #2ecc71;
            /* A subtle pop of color for success */
            --light-gray: #ecf0f1;
            --medium-gray: #bdc3c7;
            --dark-text: #2f3640;
            --light-text: #f0f0f0;
        ...
        .nav-link.text-danger {
            ...
            /* Slightly brighter red for logout */
            font-weight: 600;
        }
        ...
        #feedback {
            ...
            /* Reverse gradient for visual break */
        }
...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav align-items-lg-center">
                    ...
                    <li class="nav-item ms-lg-3 mt-3 mt-lg-0">
                        <a class="nav-link btn btn-outline-light text-danger px-4 py-2" href="#" data-bs-toggle="modal" data-bs-target="#logoutModal">
    ...
    <section class="hero">
        <div class="container">
            <h1>Welcome back, <?= ucfirst($user_data['user_name']) ?>!</h1>
    ...
    <section id="userDetails" class="py-5 bg-light">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 mb-4">
                    <div class="p-4 shadow rounded bg-white">
                        <h5>Name</h5>
                        <p class="text-muted"><?= ucfirst($user_data['user_name'] ?? 'N/A') ?></p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="p-4 shadow rounded bg-white">
                        <h5>Email</h5>
                        <p class="text-muted"><?= $user_data['user_email'] ?? 'N/A' ?></p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="p-4 shadow rounded bg-white">
                        <h5>Monthly Budget</h5>
                        <p class="text-muted">₹<?= number_format($user['budget'] ?? 0) ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="feedback" class="py-5">
        <div class="container">
            ...
            <p class="text-center lead">We're constantly striving to improve. Share your feedback!</p>
            <form id="feedbackForm" class="mx-auto" style="max-width: 700px;">
                <div class="mb-4"><label for="name" class="form-label">Your Name</label>
                    <input type="text" class="form-control" id="name" placeholder="Enter your full name" required />
                </div>
                <div class="mb-4"><label for="email" class="form-label">Your Email</label>
                    <input type="email" class="form-control" id="email" placeholder="name@example.com" required />
                </div>
                <div class="mb-4"><label for="message" class="form-label">Your Feedback</label>
                    <textarea class="form-control" id="message" rows="6" placeholder="Tell us what you think!" required></textarea>
                </div>
    ...
    <footer>
        <div class="container">
            <p class="mb-0">© 2025 ExpenseTrack. All rights reserved. Designed with ❤️ for your financial well-being.</p>
        </div>
    </footer>
    ...
    <script>
        ...
        $('#feedbackForm').submit(function(e) {
            ...
            feedbackStatus.text("Thank you for your feedback!").addClass("text-success");
        ...
        // Load backend dynamic values (PHP rendered into JS)
        document.addEventListener("DOMContentLoaded", function() {
            document.getElementById("monthlyTotal").innerText = "<?= number_format($monthly_total ?? 0) ?>";
            document.getElementById("budgetLeft").innerText = "<?= number_format($remaining_budget ?? 0) ?>";
            document.getElementById("trendMessage").innerText = "<?= $trend_message ?? 'Looking good!' ?>";
        });
    </script>
</body>
